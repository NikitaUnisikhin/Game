...
public class PowerUp : MonoBehaviour
{
    ...
    public float fadeTime = 4f; // Через сколько он будет исчезать(выцветать)
    ...
    void Awake()
    {
        ...
        vel.z = 0;
        vel.Normalize(); // Устанавливает длину Vector3 равной 1 метр
    ...
    {
        WeaponDefiniton def = Main.GetWeaponDefinition(wt);
